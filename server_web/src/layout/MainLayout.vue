...
import { RocketOutline as LogoIcon } from "@vicons/ionicons5";
...
<template>
  <n-layout has-sider class="h-screen">
    ...
    >
      <div
        class="flex items-center justify-center h-16 gap-2"
    ...
    <n-layout>
      ...
      <n-layout-footer
        class="h-[60px] flex items-center justify-center border-t border-gray-200 text-gray-600"
      >
        LightDeploy © 2025
      </n-layout-footer>
    </n-layout>
